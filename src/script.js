...
window.requestAnimationFrame(() => spotLightHelper.update()) // просто фикс бага для правильно отображения в пространстве

const rectAreaLightHelper = new RectAreaLightHelper(rectAreaLight);
scene.add(rectAreaLightHelper); // maybe will be need to update position
